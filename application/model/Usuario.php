...
class Usuario extends GenericModel 
{
    ...
    public function vwUsuarioSemUF($where = array(), $ordem=array()) {

        $slct = $this->select();
        $slct->setIntegrityCheck(false);
        $slct->from(array('vwUsuarioSemUF'),
                array('*')
        );
    ...
    public function vwAvaliacaoUsuarioSemUF($where = array(), $ordem=array()) {

        $slct = $this->select();
        $slct->setIntegrityCheck(false);
        $slct->from(array('vwAvaliacaoUsuarioSemUF'),
                array('*')
        );
