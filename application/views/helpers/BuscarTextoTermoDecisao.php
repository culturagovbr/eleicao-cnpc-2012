...
class Zend_View_Helper_BuscarTextoTermoDecisao
{
	...
	{        
            ...
            $prefixoSugestaoRelator = "<b>b) Sugest&atilde;o do Membro Relator da CNIC</b><br><br>";
            $sugestaoRelator = (!empty($arrDados['parecerCNIC'])) ? $prefixoSugestaoRelator.$arrDados['parecerComponente'] : "";
