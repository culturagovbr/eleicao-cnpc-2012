...
//class InscricaoController extends Zend_Controller_Action
{
    ...
    public function formInscricaoAction()
    {
        ...
        if($auth->hasIdentity() && $auth->getIdentity()->id_perfil != '1'){
            parent::message("O seu perfil não lhe permite acessar o formulário de cadastro.", "/admin", "ALERT");
        }
        ...
        if(empty($idSetorial) && empty($idUsuario)){
            //parent::message("É necessário informar um setorial para poder realizar o seu cadastro.", "/login", "ALERT");
			...
			if(empty($rsSetorial)){
				parent::message("É necessário informar um setorial para poder realizar o seu cadastro.", "/admin", "ALERT");
			}
            ...
            /* ==================================================*/
                ...
                if(empty($idUsuario)){ 
                    ...
                    if(!empty($rsUsuario)){
						...
						//$this->_helper->flashMessenger->addMessage("Já existe um cadastro realizado com este CPF.");
						//$this->_helper->flashMessengerType->addMessage("ERROR");
						//$this->_redirect("inscricao/form-inscricao");
                        parent::message("Já existe um cadastro realizado com este CPF.", "/inscricao/form-inscricao/setorial/".$idSetorial, "ERROR");
                        die;
                    }
                ...
                if(!empty($arquivoTemp))
                {
                    ...
                    */
                    ...
                    if(!in_array($arquivoTipo,$arrTipo))
                    {
                        ...
                        $arrRetorno['error_msg'] = "Só é permitido o envio de arquivos do tipo .pdf.";
