...
//            $pdf->WriteHTML("PDF Gerado em ".$totaltime." segundos");
        ...
        public function setarValoresCamposView($rsObj){
         //xd($rsObj);
            foreach($rsObj as $campo){
                ...
                if($campo->id_item == 19){ //file_identidade
					...
					$urlArquivo = $this->diretorioUpload.'/'.$cpf.'/identidade.pdf';
					$caminhoArquivo = $this->caminhoAcessoArquivo.$cpf.'/identidade.pdf';
					$this->view->file_identidade = (file_exists($urlArquivo)) ? $caminhoArquivo : "";
                    $nome_arquivo = null;
                    $nome_arquivo = explode("/",$campo->vhr_valor);
                    $nome_arquivo = $nome_arquivo[count($nome_arquivo)-1];
                ...
                if($campo->id_item == 20){ //file_cpf
					...
					$urlArquivo = $this->diretorioUpload.'/'.$cpf.'/cpf.pdf';
					$caminhoArquivo = $this->caminhoAcessoArquivo.$cpf.'/cpf.pdf';
					$this->view->file_cpf = (file_exists($urlArquivo)) ? $caminhoArquivo : "";
                    $nome_arquivo = null;
                    $nome_arquivo = explode("/",$campo->vhr_valor);
                    $nome_arquivo = $nome_arquivo[count($nome_arquivo)-1];
                ...
                if($campo->id_item == 21){ //file_comprovante_residencia
					...
					$urlArquivo = $this->diretorioUpload.'/'.$cpf.'/comprovante_residencia.pdf';
					$caminhoArquivo = $this->caminhoAcessoArquivo.$cpf.'/comprovante_residencia.pdf';
					$this->view->file_comprovante_residencia = (file_exists($urlArquivo)) ? $caminhoArquivo : "";
                    $nome_arquivo = null;
                    $nome_arquivo = explode("/",$campo->vhr_valor);
                    $nome_arquivo = $nome_arquivo[count($nome_arquivo)-1];
                ...
                if($campo->id_item == 27){ //file_comprovante_funcao_comissionado
					...
					$urlArquivo = $this->diretorioUpload.'/'.$cpf.'/comprovante_funcao_comissionado.pdf';
					$caminhoArquivo = $this->caminhoAcessoArquivo.$cpf.'/comprovante_funcao_comissionado.pdf';
					$this->view->file_comprovante_funcao_comissionado = (file_exists($urlArquivo)) ? $caminhoArquivo : "";
                    $nome_arquivo = null;
                    $nome_arquivo = explode("/",$campo->vhr_valor);
                    $nome_arquivo = $nome_arquivo[count($nome_arquivo)-1];
                ...
                if($campo->id_item == 29){ //file_curriculo
					...
					$urlArquivo = $this->diretorioUpload.'/'.$cpf.'/curriculo.pdf';
					$caminhoArquivo = $this->caminhoAcessoArquivo.$cpf.'/curriculo.pdf';
					$this->view->file_curriculo = (file_exists($urlArquivo)) ? $caminhoArquivo : "";
                    $nome_arquivo = null;
                    $nome_arquivo = explode("/",$campo->vhr_valor);
                    $nome_arquivo = $nome_arquivo[count($nome_arquivo)-1];
                ...
                if($campo->id_item == 30){ //file_portfolio
					...
					$urlArquivo = $this->diretorioUpload.'/'.$cpf.'/portfolio.pdf';
					$caminhoArquivo = $this->caminhoAcessoArquivo.$cpf.'/portfolio.pdf';
					$this->view->file_portfolio = (file_exists($urlArquivo)) ? $caminhoArquivo : "";
                    $nome_arquivo = null;
                    $nome_arquivo = explode("/",$campo->vhr_valor);
                    $nome_arquivo = $nome_arquivo[count($nome_arquivo)-1];
                ...
                if($campo->id_item == 32){ //file_carta_apoio
					...
					$urlArquivo = $this->diretorioUpload.'/'.$cpf.'/carta_apoio.pdf';
					$caminhoArquivo = $this->caminhoAcessoArquivo.$cpf.'/carta_apoio.pdf';
					$this->view->file_carta_apoio = (file_exists($urlArquivo)) ? $caminhoArquivo : "";
                    $nome_arquivo = null;
                    $nome_arquivo = explode("/",$campo->vhr_valor);
                    $nome_arquivo = $nome_arquivo[count($nome_arquivo)-1];
