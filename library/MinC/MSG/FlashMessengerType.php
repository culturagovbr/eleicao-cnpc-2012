<?php
/**
 * Pega o tipo da mensagem (ALERT, CONFIRM, ERROR)
 * Baseado na classe FlashMessenger
...
class Zend_Controller_Action_Helper_FlashMessengerType extends Zend_Controller_Action_Helper_Abstract implements IteratorAggregate, Countable
{
    /**
